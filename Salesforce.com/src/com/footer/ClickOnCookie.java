...
public class ClickOnCookie {
	...
	{
		driver.findElement(By.xpath("/html/body/footer/div/div[1]/div/div/div/div/div[2]/nav/ul/li[7]/a")).click();
	}
	...
	public static void main(String[] args) {
		...
		ClickOnCookie click=new ClickOnCookie();
		click.LaunchAUT();
		click.clickonCookie();
